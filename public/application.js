...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://thawing-dawn-36769.herokuapp.com',
...
var blogs = __webpack_require__(5);
var blogStack = function blogStack() {
        ...
        $("#blog-stack").append("\
              <div class='row mt-3 wow fadeIn'>\
                    ...
                    <div class='col-lg-5 col-xl-4 mb-4'>\
                        <!--Featured image-->\
                        <div class='view overlay rounded z-depth-1'>" + ("\n                            <img src='" + blogs.blogs[I].headerImage + "' class='img-fluid' alt=''>") + "\n                            <a href=\"https://mdbootstrap.com/automated-app-start/\" target=\"_blank\">\n                                <div class=\"mask rgba-white-slight\"></div>\n                            </a>\n                        </div>\n                    </div>\n                    <!--Grid column-->\n                    " + ("\n                    <!--Grid column-->\n                    <div class=\"col-lg-7 col-xl-7 ml-xl-4 mb-4\">\n                        <h3 class=\"mb-3 font-weight-bold dark-grey-text\">\n                            <strong>" + blogs.blogs[I].title + "</strong>\n                        </h3>\n                        <p class=\"grey-text\"></p>\n                        <a href=\"https://mdbootstrap.com/automated-app-start/\"  id='blog-" + blogs.blogs[I]._id + "' target=\"_blank\" class=\"btn btn-primary btn-md\">See blog\n                            <i class=\"fa fa-play ml-2\"></i>\n                        </a>\n                    </div>\n                    <!--Grid column-->\n\n                </div>\n  <hr class=\"mb-5\">\n    "));
    }
};
...
//require("./assets/styles/templateassets/css/mdb.min.css");
...
var blogApi = __webpack_require__(10);
var blogs = __webpack_require__(6);

var authEvents = __webpack_require__(12);
var postEvents = __webpack_require__(16);
...
var apiUrl = __webpack_require__(1);
var blogContainer = __webpack_require__(5);
var blogStack = __webpack_require__(6);
var createBlogRequest = __webpack_require__(11);
...
var authenticatedUser = __webpack_require__(2);
var apiUrl = __webpack_require__(1);

var addBlog = function addBlog() {
  $("#create-blog").on("submit", function (event) {
    event.preventDefault();
    var serialization = $("#create-blog").serializeArray();
    $.ajax({
      url: apiUrl.apiUrl + '/blogs',
      method: "POST",
      headers: {
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(this);
  console.log('In sign in and the data is ', data);
...
var addHandler = function addHandler() {
  ...
  $("#create-blog-button").on("click", function () {
    return $("#create-blog-modal").css("display", "block");
  });
...
var onCreatePost = function onCreatePost(event) {
  ...
  api.createPost(data).then(ui.createPostSuccess).catch(ui.postError);
};

var onShowPost = function onShowPost(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  console.log('In onReadPost in post events and the data is ', data);
  api.showPost(data).then(ui.readPostSuccess).catch(ui.postError);
};
...
var readPostSuccess = function readPostSuccess(data) {
...
module.exports = {
    ...
    readPostSuccess: readPostSuccess,
...
var WOW;jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, { def: "easeOutQuad", swing: function swing(t, e, i, n, a) {
    ...
    var r = 1.70158,
        o = 0,
        s = n;if (0 == e) return i;if (1 == (e /= a)) return i + n;if (o || (o = .3 * a), s < Math.abs(n)) {
      s = n;r = o / 4;
    } else r = o / (2 * Math.PI) * Math.asin(n / s);return -s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o) + i;
  }, easeOutElastic: function easeOutElastic(t, e, i, n, a) {
    var r = 1.70158,
        o = 0,
        s = n;if (0 == e) return i;if (1 == (e /= a)) return i + n;if (o || (o = .3 * a), s < Math.abs(n)) {
      s = n;r = o / 4;
    } else r = o / (2 * Math.PI) * Math.asin(n / s);return s * Math.pow(2, -10 * e) * Math.sin((e * a - r) * (2 * Math.PI) / o) + n + i;
  }, easeInOutElastic: function easeInOutElastic(t, e, i, n, a) {
    var r = 1.70158,
        o = 0,
        s = n;if (0 == e) return i;if (2 == (e /= a / 2)) return i + n;if (o || (o = a * (.3 * 1.5)), s < Math.abs(n)) {
      s = n;r = o / 4;
    } else r = o / (2 * Math.PI) * Math.asin(n / s);return e < 1 ? s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o) * -.5 + i : s * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o) * .5 + n + i;
  ...
  function e(t) {
    ...
    var i = function i(t, e) {
      ...
      return null == t ? t + "" : "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) || "function" == typeof t ? a[o.call(t)] || "object" : typeof t === "undefined" ? "undefined" : _typeof(t);
      ...
      var a = 0,
          r = t.length,
          o = e(t);if (n) {
        if (o) for (; r > a && !1 !== i.apply(t[a], n); a++) {} else for (a in t) {
          if (!1 === i.apply(t[a], n)) break;
        }
      } else if (o) for (; r > a && !1 !== i.call(t[a], a, t[a]); a++) {} else for (a in t) {
        if (!1 === i.call(t[a], a, t[a])) break;
      }return t;
    }, i.data = function (t, e, a) {
      if (void 0 === a) {
        var r = (o = t[i.expando]) && n[o];if (void 0 === e) return r;if (r && e in r) return r[e];
      } else if (void 0 !== e) {
        var o = t[i.expando] || (t[i.expando] = ++i.uuid);return n[o] = n[o] || {}, n[o][e] = a, a;
      }
    }, i.removeData = function (t, e) {
      var a = t[i.expando],
          r = a && n[a];r && i.each(e, function (t, e) {
        delete r[e];
      });
    }, i.extend = function () {
      var t,
          ...
          l = 1,
          u = arguments.length,
          d = !1;for ("boolean" == typeof s && (d = s, s = arguments[l] || {}, l++), "object" != (typeof s === "undefined" ? "undefined" : _typeof(s)) && "function" !== i.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++) {
      ...
      if (t) {
        n = (n || "fx") + "queue";var r = i.data(t, n);return a ? (!r || i.isArray(a) ? r = i.data(t, n, function (t, i) {
      ...
      i.each(t.nodeType ? [t] : t, function (t, n) {
        e = e || "fx";var a = i.queue(n, e),
            r = a.shift();"inprogress" === r && (r = a.shift()), r && ("fx" === e && a.unshift("inprogress"), r.call(n, function () {
          i.dequeue(n, e);
        }));
      });
      ...
      } };var n = {};i.expando = "velocity" + new Date().getTime(), i.uuid = 0;for (var a = {}, r = a.hasOwnProperty, o = a.toString, s = "Boolean Number String Function Array Date RegExp Object Error".split(" "), l = 0; l < s.length; l++) {
  ...
  return function (t, e, i, n) {
    function a(t) {
      ...
      function r(t, e) {
        ...
        for (var a = 0; f > a; ++a) {
          var r = u(i, t, n);if (0 === r) return i;i -= (l(i, t, n) - e) / r;
        }return i;
      }function c(e, i, a) {
        var r,
            o,
        ...
        } while (Math.abs(r) > g && ++s < v);return o;
      }function h() {
        k = !0, (t != i || n != a) && function () {
          ...
          m = 11,
          b = 1 / (m - 1),
          y = "Float32Array" in e;if (4 !== arguments.length) return !1;for (var x = 0; 4 > x; ++x) {
        if ("number" != typeof arguments[x] || isNaN(arguments[x]) || !isFinite(arguments[x])) return !1;
      }t = Math.min(t, 1), n = Math.min(n, 1), t = Math.max(t, 0), n = Math.max(n, 0);var w = y ? new Float32Array(m) : new Array(m),
          k = !1,
          S = function S(e) {
        return k || h(), t === i && n === a ? e : 0 === e ? 0 : 1 === e ? 1 : l(function (e) {
          for (var i = 0, a = 1, r = m - 1; a != r && w[a] <= e; ++a) {
            i += b;
          }var o = i + (e - w[--a]) / (w[a + 1] - w[a]) * b,
              s = u(o, t, n);return s >= p ? d(e, o) : 0 == s ? o : c(e, i, i + b);
        }(e), i, a);
      };S.getControlPoints = function () {
        return [{ x: t, y: i }, { x: n, y: a }];
      };var C = "generateBezier(" + [t, i, n, a] + ")";return S.toString = function () {
        return C;
      }, S;
    }function s(t, e) {
      var i = t;return f.isString(t) ? m.Easings[t] || (i = !1) : i = f.isArray(t) && 1 === t.length ? function (t) {
        return function (e) {
          return Math.round(e * t) * (1 / t);
        };
      }.apply(null, t) : f.isArray(t) && 2 === t.length ? b.apply(null, t.concat([e])) : !(!f.isArray(t) || 4 !== t.length) && o.apply(null, t), !1 === i && (i = m.Easings[m.defaults.easing] ? m.defaults.easing : v), i;
    }function l(t) {
      if (t) {
        var e = new Date().getTime(),
            i = m.State.calls.length;i > 1e4 && (m.State.calls = function (t) {
          for (var e = -1, i = t ? t.length : 0, n = []; ++e < i;) {
            var a = t[e];a && n.push(a);
          }return n;
        }(m.State.calls));for (var a = 0; i > a; a++) {
          if (m.State.calls[a]) {
            var o = m.State.calls[a],
                ...
                h = o[3],
                p = !!h,
                g = null;h || (h = m.State.calls[a][3] = e - 16);for (var v = Math.min((e - h) / c.duration, 1), b = 0, x = s.length; x > b; b++) {
              var k = s[b],
                  S = k.element;if (r(S)) {
                var C = !1;if (c.display !== n && null !== c.display && "none" !== c.display) {
                  if ("flex" === c.display) {
                  ...
                  if ("element" !== M) {
                    var P,
                        A = k[M],
                        T = f.isString(A.easing) ? m.Easings[A.easing] : A.easing;if (1 === v) P = A.endValue;else {
                      var I = A.endValue - A.startValue;if (P = A.startValue + I * T(v, c, I), !p && P === A.currentValue) continue;
                    }if (A.currentValue = P, "tween" === M) g = P;else {
                      if (y.Hooks.registered[M]) {
                        var _ = y.Hooks.getRoot(M),
                            D = r(S).rootPropertyValueCache[_];D && (A.rootPropertyValue = D);
                      }var F = y.setPropertyValue(S, M, A.currentValue + (0 === parseFloat(P) ? "" : A.unitType), A.rootPropertyValue, A.scrollData);y.Hooks.registered[M] && (r(S).rootPropertyValueCache[_] = y.Normalizations.registered[_] ? y.Normalizations.registered[_]("extract", null, F[1]) : F[1]), "transform" === F[0] && (C = !0);
                    }
                  }
      ...
      if (!m.State.calls[t]) return !1;for (var i = m.State.calls[t][0], a = m.State.calls[t][1], o = m.State.calls[t][2], s = m.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
        var h = i[u].element;if (e || o.loop || ("none" === o.display && y.setPropertyValue(h, "display", o.display), "hidden" === o.visibility && y.setPropertyValue(h, "visibility", o.visibility)), !0 !== o.loop && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && r(h)) {
          r(h).isAnimating = !1, r(h).rootPropertyValueCache = {};var f = !1;d.each(y.Lists.transforms3D, function (t, e) {
        ...
        }), m(h, "reverse", { loop: !0, delay: o.delay })), !1 !== o.queue && d.dequeue(h, o.queue);
      }m.State.calls[t] = !1;for (var p = 0, g = m.State.calls.length; g > p; p++) {
      ...
      var t = 0;return e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || function (e) {
        ...
        f = { isString: function isString(t) {
        ...
        p = !1;if (t.fn && t.fn.jquery ? (d = t, p = !0) : d = e.Velocity.Utilities, 8 >= c && !p) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");if (!(7 >= c)) {
      var g = 400,
          v = "swing",
          m = { State: { isMobile: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), isAndroid: /Android/i.test(navigator.userAgent), isGingerbread: /Android 2\.3\.[3-7]/i.test(navigator.userAgent), isChrome: e.chrome, isFirefox: /Firefox/i.test(navigator.userAgent), prefixElement: i.createElement("div"), prefixMatches: {}, scrollAnchor: null, scrollPropertyLeft: null, scrollPropertyTop: null, isTicking: !1, calls: [] }, CSS: {}, Utilities: d, Redirects: {}, Easings: {}, Promise: e.Promise, defaults: { queue: "", duration: g, easing: v, begin: n, complete: n, progress: n, display: n, visibility: n, loop: !1, delay: !1, mobileHA: !0, _cacheValues: !0 }, init: function init(t) {
          d.data(t, "velocity", { isSVG: f.isSVG(t), isAnimating: !1, computedStyle: null, tweensContainer: null, rootPropertyValueCache: {}, transformCache: {} });
        }, hook: null, mock: !1, version: { major: 1, minor: 2, patch: 2 }, debug: !1 };e.pageYOffset !== n ? (m.State.scrollAnchor = e, m.State.scrollPropertyLeft = "pageXOffset", m.State.scrollPropertyTop = "pageYOffset") : (m.State.scrollAnchor = i.documentElement || i.body.parentNode || i.body, m.State.scrollPropertyLeft = "scrollLeft", m.State.scrollPropertyTop = "scrollTop");var b = function () {
        function t(t) {
          ...
          var a = { dx: i.v, dv: t(i) },
              ...
              u = 1 / 6 * (a.dv + 2 * (r.dv + o.dv) + s.dv);return i.x = i.x + l * n, i.v = i.v + u * n, i;
          ...
          var r,
              ...
              u = [0],
              d = 0;for (e = parseFloat(e) || 500, n = parseFloat(n) || 20, a = a || null, l.tension = e, l.friction = n, (r = null !== a) ? o = (d = t(e, n)) / a * .016 : o = .016; s = i(s || l, o), u.push(1 + s.x), d += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;) {}return r ? function (t) {
            return u[t * (u.length - 1) | 0];
          } : d;
        };
      }();m.Easings = { linear: function linear(t) {
          return t;
        ...
        m.Easings[e[0]] = o.apply(null, e[1]);
            ...
            for (var t = 0; t < y.Lists.colors.length; t++) {
              var e = "color" === y.Lists.colors[t] ? "0 0 0 1" : "255 255 255 1";y.Hooks.templates[y.Lists.colors[t]] = ["Red Green Blue Alpha", e];
            }var i, n, a;if (c) for (i in y.Hooks.templates) {
              a = (n = y.Hooks.templates[i])[0].split(" ");var r = n[1].match(y.RegEx.valueSplit);"Color" === a[0] && (a.push(a.shift()), r.push(r.shift()), y.Hooks.templates[i] = [a.join(" "), r.join(" ")]);
            }for (i in y.Hooks.templates) {
              for (var t in a = (n = y.Hooks.templates[i])[0].split(" ")) {
                var o = i + a[t],
                    s = t;y.Hooks.registered[o] = [i, s];
              }
            }
          }, getRoot: function getRoot(t) {
            var e = y.Hooks.registered[t];return e ? e[0] : t;
            ...
            var i = y.Hooks.registered[t];if (i) {
              var n = i[0],
                  a = i[1];return (e = y.Hooks.cleanRootPropertyValue(n, e)).toString().match(y.RegEx.valueSplit)[a];
            }return e;
          }, injectValue: function injectValue(t, e, i) {
            var n = y.Hooks.registered[t];if (n) {
              var a,
                  r = n[0],
                  o = n[1];return (a = (i = y.Hooks.cleanRootPropertyValue(r, i)).toString().match(y.RegEx.valueSplit))[o] = e, a.join(" ");
            }return i;
          } }, Normalizations: { registered: { clip: function clip(t, e, i) {
              switch (t) {case "name":
                  return "clip";case "extract":
                  var n;return y.RegEx.wrappedValueAlreadyExtracted.test(i) ? n = i : n = (n = i.toString().match(y.RegEx.valueUnwrap)) ? n[1].replace(/,(\s+)?/g, " ") : i, n;case "inject":
                  return "rect(" + i + ")";}
            }, blur: function blur(t, e, i) {
              switch (t) {case "name":
                  return m.State.isFirefox ? "filter" : "-webkit-filter";case "extract":
              ...
              if (8 >= c) switch (t) {case "name":
                  return "filter";case "extract":
                  var n = i.toString().match(/alpha\(opacity=(.*)\)/i);return n ? n[1] / 100 : 1;case "inject":
            ...
            9 >= c || m.State.isGingerbread || (y.Lists.transformsBase = y.Lists.transformsBase.concat(y.Lists.transforms3D));for (var t = 0; t < y.Lists.transformsBase.length; t++) {
              !function () {
                var e = y.Lists.transformsBase[t];y.Normalizations.registered[e] = function (t, i, a) {
                  switch (t) {case "name":
                      ...
                      var o = !1;switch (e.substr(0, e.length - 1)) {case "translate":
                          ...
                          m.State.isAndroid && r(i).transformCache[e] === n && 1 > a && (a = 1), o = !/(\d)$/i.test(a);break;case "skew":
              ...
              !function () {
                var e = y.Lists.colors[t];y.Normalizations.registered[e] = function (t, i, a) {
                  switch (t) {case "name":
                      return e;case "extract":
                      var r;if (y.RegEx.wrappedValueAlreadyExtracted.test(a)) r = a;else {
                        var o,
                            s = { black: "rgb(0, 0, 0)", blue: "rgb(0, 0, 255)", gray: "rgb(128, 128, 128)", green: "rgb(0, 128, 0)", red: "rgb(255, 0, 0)", white: "rgb(255, 255, 255)" };/^[A-z]+$/i.test(a) ? o = s[a] !== n ? s[a] : s.black : y.RegEx.isHex.test(a) ? o = "rgb(" + y.Values.hexToRgb(a).join(" ") + ")" : /^rgba?\(/i.test(a) || (o = s.black), r = (o || a).toString().match(y.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ");
            ...
            var e = "width|height|x|y|cx|cy|r|rx|ry|x1|x2|y1|y2";return (c || m.State.isAndroid && !m.State.isChrome) && (e += "|transform"), new RegExp("^(" + e + ")$", "i").test(t);
          }, prefixCheck: function prefixCheck(t) {
            if (m.State.prefixMatches[t]) return [m.State.prefixMatches[t], !0];for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
              var a;if (a = 0 === i ? t : e[i] + t.replace(/^\w/, function (t) {
                return t.toUpperCase();
              }), f.isString(m.State.prefixElement.style[a])) return m.State.prefixMatches[t] = a, [a, !0];
            }return [t, !1];
          } }, Values: { hexToRgb: function hexToRgb(t) {
            var e;return t = t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (t, e, i, n) {
              return e + e + i + i + n + n;
          ...
          function s(t, i) {
            function a() {
            ...
            }var l = 0;if (8 >= c) l = d.css(t, i);else {
              var u,
                  h = !1;if (/^(width|height)$/.test(i) && 0 === y.getPropertyValue(t, "display") && (h = !0, y.setPropertyValue(t, "display", y.Values.getDisplayType(t))), !o) {
                if ("height" === i && "border-box" !== y.getPropertyValue(t, "boxSizing").toString().toLowerCase()) {
                  var f = t.offsetHeight - (parseFloat(y.getPropertyValue(t, "borderTopWidth")) || 0) - (parseFloat(y.getPropertyValue(t, "borderBottomWidth")) || 0) - (parseFloat(y.getPropertyValue(t, "paddingTop")) || 0) - (parseFloat(y.getPropertyValue(t, "paddingBottom")) || 0);return a(), f;
                }if ("width" === i && "border-box" !== y.getPropertyValue(t, "boxSizing").toString().toLowerCase()) {
                  var p = t.offsetWidth - (parseFloat(y.getPropertyValue(t, "borderLeftWidth")) || 0) - (parseFloat(y.getPropertyValue(t, "borderRightWidth")) || 0) - (parseFloat(y.getPropertyValue(t, "paddingLeft")) || 0) - (parseFloat(y.getPropertyValue(t, "paddingRight")) || 0);return a(), p;
                }
              ...
              var g = s(t, "position");("fixed" === g || "absolute" === g && /top|left/i.test(i)) && (l = d(t).position()[i] + "px");
            }return l;
          }var l;if (y.Hooks.registered[i]) {
            var u = i,
                h = y.Hooks.getRoot(u);a === n && (a = y.getPropertyValue(t, y.Names.prefixCheck(h)[0])), y.Normalizations.registered[h] && (a = y.Normalizations.registered[h]("extract", t, a)), l = y.Hooks.extractValue(u, a);
          } else if (y.Normalizations.registered[i]) {
            var f, p;"transform" !== (f = y.Normalizations.registered[i]("name", t)) && (p = s(t, y.Names.prefixCheck(f)[0]), y.Values.isCSSNullValue(p) && y.Hooks.templates[i] && (p = y.Hooks.templates[i][1])), l = y.Normalizations.registered[i]("extract", t, p);
          ...
          } else l = s(t, y.Names.prefixCheck(i)[0]);return y.Values.isCSSNullValue(l) && (l = 0), m.debug >= 2 && console.log("Get " + i + ": " + l), l;
        }, setPropertyValue: function setPropertyValue(t, i, n, a, o) {
          var s = i;if ("scroll" === i) o.container ? o.container["scroll" + o.direction] = n : "Left" === o.direction ? e.scrollTo(n, o.alternateValue) : e.scrollTo(o.alternateValue, n);else if (y.Normalizations.registered[i] && "transform" === y.Normalizations.registered[i]("name", t)) y.Normalizations.registered[i]("inject", t, n), s = "transform", n = r(t).transformCache[i];else {
            if (y.Hooks.registered[i]) {
              var l = i,
                  u = y.Hooks.getRoot(i);a = a || y.getPropertyValue(t, u), n = y.Hooks.injectValue(l, n, a), i = u;
              ...
              m.debug && console.log("Browser does not support [" + n + "] for [" + s + "]");
            } else r(t) && r(t).isSVG && y.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[s] = n;m.debug >= 2 && console.log("Set " + i + " (" + s + "): " + n);
          }return [s, n];
        }, flushTransformCache: function flushTransformCache(t) {
          function e(e) {
            return parseFloat(y.getPropertyValue(t, e));
          }var i = "";if ((c || m.State.isAndroid && !m.State.isChrome) && r(t).isSVG) {
            var n = { translate: [e("translateX"), e("translateY")], skewX: [e("skewX")], skewY: [e("skewY")], scale: 1 !== e("scale") ? [e("scale"), e("scale")] : [e("scaleX"), e("scaleY")], rotate: [e("rotateZ"), 0, 0] };d.each(r(t).transformCache, function (t) {
              /^translate/i.test(t) ? t = "translate" : /^scale/i.test(t) ? t = "scale" : /^rotate/i.test(t) && (t = "rotate"), n[t] && (i += t + "(" + n[t].join(" ") + ") ", delete n[t]);
            });
          } else {
            var a, o;d.each(r(t).transformCache, function (e) {
        ...
        var o = n;return t = a(t), d.each(t, function (t, a) {
          if (r(a) === n && m.init(a), i === n) o === n && (o = m.CSS.getPropertyValue(a, e));else {
            var s = m.CSS.setPropertyValue(a, e, i);"transform" === s[0] && m.CSS.flushTransformCache(a), o = s;
          }
        }), o;
      };var x = function x() {
        function t() {
          ...
          function t(t) {
            function h(t, e) {
              var i = n,
                  a = n,
                  r = n;return f.isArray(t) ? (i = t[0], !f.isArray(t[1]) && /^[\d-]/.test(t[1]) || f.isFunction(t[1]) || y.RegEx.isHex.test(t[1]) ? r = t[1] : (f.isString(t[1]) && !y.RegEx.isHex.test(t[1]) || f.isArray(t[1])) && (a = e ? t[1] : s(t[1], u.duration), t[2] !== n && (r = t[2]))) : i = t, e || (a = a || u.easing), f.isFunction(i) && (i = i.call(o, C, S)), f.isFunction(r) && (r = r.call(o, C, S)), [i || 0, a, r];
            }function p(t, e) {
              ...
              var t = { myParent: o.parentNode || i.body, position: y.getPropertyValue(o, "position"), fontSize: y.getPropertyValue(o, "fontSize") },
                  ...
                  a = t.fontSize === L.lastFontSize;L.lastParent = t.myParent, L.lastPosition = t.position, L.lastFontSize = t.fontSize;var s = 100,
                  l = {};if (a && n) l.emToPx = L.lastEmToPx, l.percentToPxWidth = L.lastPercentToPxWidth, l.percentToPxHeight = L.lastPercentToPxHeight;else {
                var u = r(o).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");m.init(u), t.myParent.appendChild(u), d.each(["overflow", "overflowX", "overflowY"], function (t, e) {
                  m.CSS.setPropertyValue(u, e, "hidden");
                }), m.CSS.setPropertyValue(u, "position", t.position), m.CSS.setPropertyValue(u, "fontSize", t.fontSize), m.CSS.setPropertyValue(u, "boxSizing", "content-box"), d.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function (t, e) {
                  m.CSS.setPropertyValue(u, e, s + "%");
                }), m.CSS.setPropertyValue(u, "paddingLeft", s + "em"), l.percentToPxWidth = L.lastPercentToPxWidth = (parseFloat(y.getPropertyValue(u, "width", null, !0)) || 1) / s, l.percentToPxHeight = L.lastPercentToPxHeight = (parseFloat(y.getPropertyValue(u, "height", null, !0)) || 1) / s, l.emToPx = L.lastEmToPx = (parseFloat(y.getPropertyValue(u, "paddingLeft")) || 1) / s, t.myParent.removeChild(u);
              ...
              var x,
                  ...
                  I = parseFloat(u.offset) || 0;u.container ? f.isWrapped(u.container) || f.isNode(u.container) ? (u.container = u.container[0] || u.container, M = (x = u.container["scroll" + T]) + d(o).position()[T.toLowerCase()] + I) : u.container = null : (x = m.State.scrollAnchor[m.State["scrollProperty" + T]], k = m.State.scrollAnchor[m.State["scrollProperty" + ("Left" === T ? "Top" : "Left")]], M = d(o).offset()[T.toLowerCase()] + I), c = { scroll: { rootPropertyValue: !1, startValue: x, currentValue: x, endValue: M, unitType: "", easing: u.easing, scrollData: { container: u.container, direction: T, alternateValue: k } }, element: o }, m.debug && console.log("tweensContainer (scroll): ", c.scroll, o);
            } else if ("reverse" === P) {
              if (!r(o).tweensContainer) return void d.dequeue(o, u.queue);"none" === r(o).opts.display && (r(o).opts.display = "auto"), "hidden" === r(o).opts.visibility && (r(o).opts.visibility = "visible"), r(o).opts.loop = !1, r(o).opts.begin = null, r(o).opts.complete = null, w.easing || delete u.easing, w.duration || delete u.duration, u = d.extend({}, r(o).opts, u);var _ = d.extend(!0, {}, r(o).tweensContainer);for (var D in _) {
                if ("element" !== D) {
                  var F = _[D].startValue;_[D].startValue = _[D].currentValue = _[D].endValue, _[D].endValue = F, f.isEmptyObject(w) || (_[D].easing = u.easing), m.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(_[D]), o);
                }
              }c = _;
            } else if ("start" === P) {
              for (var O in r(o).tweensContainer && !0 === r(o).isAnimating && (_ = r(o).tweensContainer), d.each(b, function (t, e) {
                ...
                var V = h(b[O]),
                    z = V[0],
                    N = V[1],
                    B = V[2];O = y.Names.camelCase(O);var E = y.Hooks.getRoot(O),
                    W = !1;if (r(o).isSVG || "tween" === E || !1 !== y.Names.prefixCheck(E)[1] || y.Normalizations.registered[E] !== n) {
                  (u.display !== n && null !== u.display && "none" !== u.display || u.visibility !== n && "hidden" !== u.visibility) && /opacity|filter/.test(O) && !B && 0 !== z && (B = 0), u._cacheValues && _ && _[O] ? (B === n && (B = _[O].endValue + _[O].unitType), W = r(o).rootPropertyValueCache[E]) : y.Hooks.registered[O] ? B === n ? (W = y.getPropertyValue(o, E), B = y.getPropertyValue(o, O, W)) : W = y.Hooks.templates[E][1] : B === n && (B = y.getPropertyValue(o, O));var H,
                      j,
                      q,
                      Y = !1;if (B = (H = p(O, B))[0], q = H[1], z = (H = p(O, z))[0].replace(/^([+-\/*])=/, function (t, e) {
                    return Y = e, "";
                    ...
                    a = a || g();var U = /margin|padding|left|right|width|text|word|letter/i.test(O) || /X$/.test(O) || "x" === O ? "x" : "y";switch (q) {case "%":
                        B *= "x" === U ? a.percentToPxWidth : a.percentToPxHeight;break;case "px":
                        break;default:
                        B *= a[q + "ToPx"];}switch (j) {case "%":
                        B *= 1 / ("x" === U ? a.percentToPxWidth : a.percentToPxHeight);break;case "px":
                        break;default:
                        B *= 1 / a[j + "ToPx"];}
                  }switch (Y) {case "+":
                      z = B + z;break;case "-":
                      z = B - z;break;case "*":
                      z *= B;break;case "/":
                      z = B / z;}c[O] = { rootPropertyValue: W, startValue: B, currentValue: B, endValue: z, unitType: j, easing: N }, m.debug && console.log("tweensContainer (" + O + "): " + JSON.stringify(c[O]), o);
                } else m.debug && console.log("Skipping [" + E + "] due to a lack of browser support.");
              }c.element = o;
              ...
              c = {};switch (r(o) === n && m.init(o), parseFloat(u.delay) && !1 !== u.queue && d.queue(o, u.queue, function (t) {
            m.velocityQueueEntryFlag = !0, r(o).delayTimer = { setTimeout: setTimeout(t, parseFloat(u.delay)), next: t };
          }), u.duration.toString().toLowerCase()) {case "fast":
              u.duration = 200;break;case "normal":
              u.duration = g;break;case "slow":
            ...
            return !0 === i ? (A.promise && A.resolver(v), !0) : (m.velocityQueueEntryFlag = !0, void t());
            ...
            b,
            w,
            k = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || f.isString(arguments[0].properties));if (f.isWrapped(this) ? (c = !1, p = 0, v = this, h = this) : (c = !0, p = 1, v = k ? arguments[0].elements || arguments[0].e : arguments[0]), v = a(v)) {
          k ? (b = arguments[0].properties || arguments[0].p, w = arguments[0].options || arguments[0].o) : (b = arguments[p], w = arguments[p + 1]);var S = v.length,
              C = 0;if (!/^(stop|finish)$/i.test(b) && !d.isPlainObject(w)) {
            w = {};for (var M = p + 1; M < arguments.length; M++) {
              ...
              A = { promise: null, resolver: null, rejecter: null };switch (c && m.Promise && (A.promise = new m.Promise(function (t, e) {
            A.resolver = t, A.rejecter = e;
          })), b) {case "scroll":
              P = "scroll";break;case "reverse":
              P = "reverse";break;case "finish":case "stop":
              d.each(v, function (t, e) {
              ...
              });var T = [];return d.each(m.State.calls, function (t, e) {
                e && d.each(e[1], function (i, a) {
                  var o = w === n ? "" : w;return !0 !== o && e[2].queue !== o && (w !== n || !1 !== e[2].queue) || void d.each(v, function (i, n) {
                ...
                u(e, !0);
              }), A.promise && A.resolver(v)), t();default:
              if (!d.isPlainObject(b) || f.isEmptyObject(b)) {
                if (f.isString(b) && m.Redirects[b]) {
                  var I = (O = d.extend({}, w)).duration,
                      _ = O.delay || 0;return !0 === O.backwards && (v = d.extend(!0, [], v).reverse()), d.each(v, function (t, e) {
                    parseFloat(O.stagger) ? O.delay = _ + parseFloat(O.stagger) * t : f.isFunction(O.stagger) && (O.delay = _ + O.stagger.call(e, t, S)), O.drag && (O.duration = parseFloat(I) || (/^(callout|transition)/.test(b) ? 1e3 : g), O.duration = Math.max(O.duration * (O.backwards ? 1 - t / S : (t + 1) / S), .75 * O.duration, 200)), m.Redirects[b].call(e, e, O || {}, t, S, v, A.promise ? A : n);
                  }), t();
                }var D = "Velocity: First argument (" + b + ") was not a property map, a known action, or a registered redirect. Aborting.";return A.promise ? A.rejecter(new Error(D)) : console.log(D), t();
              }P = "start";}var F,
              O,
              ...
              R = [];if (d.each(v, function (t, e) {
            f.isNode(e) && o.call(e);
          }), (O = d.extend({}, m.defaults, w)).loop = parseInt(O.loop), F = 2 * O.loop - 1, O.loop) for (var V = 0; F > V; V++) {
            var z = { delay: O.delay, progress: O.progress };V === F - 1 && (z.display = O.display, z.visibility = O.visibility, z.complete = O.complete), x(v, "reverse", z);
          }return t();
        }
      };(m = d.extend(x, m)).animate = x;var w = e.requestAnimationFrame || h;return m.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
        i.hidden ? (w = function w(t) {
          return setTimeout(function () {
            t(!0);
          }, 16);
        }, l()) : w = e.requestAnimationFrame || h;
      }), t.Velocity = m, t !== e && (t.fn.velocity = x, t.fn.velocity.defaults = m.defaults), d.each(["Down", "Up"], function (t, e) {
        m.Redirects["slide" + e] = function (t, i, a, r, o, s) {
          var l = d.extend({}, i),
              u = l.begin,
              c = l.complete,
              h = { height: "", marginTop: "", marginBottom: "", paddingTop: "", paddingBottom: "" },
              f = {};l.display === n && (l.display = "Down" === e ? "inline" === m.CSS.Values.getDisplayType(t) ? "inline-block" : "block" : "none"), l.begin = function () {
            for (var i in u && u.call(o, o), h) {
              f[i] = t.style[i];var n = m.CSS.getPropertyValue(t, i);h[i] = "Down" === e ? [n, 0] : [0, n];
        ...
        m.Redirects["fade" + e] = function (t, i, a, r, o, s) {
          var l = d.extend({}, i),
              u = { opacity: "In" === e ? 1 : 0 },
              c = l.complete;l.complete = a !== r - 1 ? l.begin = null : function () {
            c && c.call(o, o), s && s.resolver(o);
          }, l.display === n && (l.display = "In" === e ? "auto" : "none"), m(this, u, l);
        };
      }), m;
    ...
    return function t(e, i, n) {
      ...
      var n = t(6);function a(t) {
        ...
        var e = t.toString(16).toUpperCase();return e.length < 2 ? "0" + e : e;
          ...
          var e = a(t);if (e) return e[3];if (e = r(t)) return e[3];if (e = o(t)) return e[3];
      ...
      var n = t(5),
        ...
        return t instanceof r ? t : this instanceof r ? (this.valid = !1, this.values = { rgb: [0, 0, 0], hsl: [0, 0, 0], hsv: [0, 0, 0], hwb: [0, 0, 0], cmyk: [0, 0, 0, 0], alpha: 1 }, void ("string" == typeof t ? (e = a.getRgba(t)) ? this.setValues("rgb", e) : (e = a.getHsla(t)) ? this.setValues("hsl", e) : (e = a.getHwb(t)) && this.setValues("hwb", e) : "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && (void 0 !== (e = t).r || void 0 !== e.red ? this.setValues("rgb", e) : void 0 !== e.l || void 0 !== e.lightness ? this.setValues("hsl", e) : void 0 !== e.v || void 0 !== e.value ? this.setValues("hsv", e) : void 0 !== e.w || void 0 !== e.whiteness ? this.setValues("hwb", e) : void 0 === e.c && void 0 === e.cyan || this.setValues("cmyk", e)))) : new r(t);var e;
          ...
          var i = t,
              ...
              s = 1 - o;return this.rgb(o * this.red() + s * i.red(), o * this.green() + s * i.green(), o * this.blue() + s * i.blue()).alpha(this.alpha() * n + i.alpha() * (1 - n));
      ...
      function n(t) {
        ...
        var e,
            ...
            s = t[1] / 100,
            l = t[2] / 100,
            u = s + l;switch (u > 1 && (s /= u, l /= u), i = 1 - l, n = 6 * o - (e = Math.floor(6 * o)), 0 != (1 & e) && (n = 1 - n), a = s + n * (i - s), e) {default:case 6:case 0:
        ...
        return C[t];
          ...
          return x(m(t));
        }, lab2xyz: y, lab2rgb: w, lab2lch: x, lch2lab: k, lch2xyz: function lch2xyz(t) {
          return y(k(t));
      ...
      var n = t(25),
        ...
        t.controllers.bar = t.DatasetController.extend({ dataElementType: a.Rectangle, initialize: function initialize() {
            ...
            var i,
                ...
                f = d.options.stacked,
                p = u.stack,
                g = 0;if (f || void 0 === f && void 0 !== p) for (i = 0; i < t; ++i) {
            ...
            var n = i.scale.options,
              ...
              var n,
                  ...
                  l = i.categoryPercentage;return null === o && (o = r - (null === s ? e.end - r : s - r)), null === s && (s = r + r - o), n = r - (r - o) / 2 * l, { chunk: (s - o) / 2 * l / e.stackCount, ratio: i.barPercentage, start: n };
            }(e, i, n) : function (t, e, i) {
              var n,
                  a,
                  o = i.barThickness,
                  s = e.stackCount,
                  l = e.pixels[t];return r.isNullOrUndef(o) ? (n = e.min * i.categoryPercentage, a = i.barPercentage) : (n = o * s, a = 1), { chunk: n / s, ratio: a, start: l - n / 2 };
            }(e, i, n),
                o = this.getStackIndex(t, this.getMeta().stack),
                s = a.start + a.chunk * o + a.chunk / 2,
                l = Math.min(r.valueOrDefault(n.maxBarThickness, 1 / 0), a.chunk * a.ratio);return { base: s - l / 2, head: s + l / 2, center: s, size: l };
          }, draw: function draw() {
            var t = this.chart,
      ...
      var n = t(25),
        ...
        t.controllers.bubble = t.DatasetController.extend({ dataElementType: a.Point, update: function update(t) {
            ...
            var n = this,
                ...
                d = n.index,
                c = i ? o.getPixelForDecimal(.5) : o.getPixelForValue("object" == (typeof u === "undefined" ? "undefined" : _typeof(u)) ? u : NaN, e, d),
                h = i ? s.getBasePixel() : s.getPixelForValue(u, e, d);t._xScale = o, t._yScale = s, t._options = l, t._datasetIndex = d, t._index = e, t._model = { backgroundColor: l.backgroundColor, borderColor: l.borderColor, borderWidth: l.borderWidth, hitRadius: l.hitRadius, pointStyle: l.pointStyle, radius: i ? 0 : l.radius, skip: r.skip || isNaN(c) || isNaN(h), x: c, y: h }, t.pivot();
          }, setHoverStyle: function setHoverStyle(t) {
            var e = t._model,
            ...
            var i,
                ...
                p = ["backgroundColor", "borderColor", "borderWidth", "hoverBackgroundColor", "hoverBorderColor", "hoverBorderWidth", "hoverRadius", "hitRadius", "pointStyle"];for (i = 0, n = p.length; i < n; ++i) {
        ...
        t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({ dataElementType: a.Arc, linkScales: r.noop, getRingIndex: function getRingIndex(t) {
            ...
            var e = this,
              ...
              var p = a.rotation % (2 * Math.PI),
                  ...
                  M = { width: .5 * (C.x - S.x), height: .5 * (C.y - S.y) };u = Math.min(s / M.width, l / M.height), d = { x: -.5 * (C.x + S.x), y: -.5 * (C.y + S.y) };
        ...
        function e(t, e) {
          return r.valueOrDefault(t.showLine, e.showLines);
            ...
            var i,
                ...
                f = o.getDataset(),
                p = e(f, d);for (p && (a = l.custom || {}, void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension), l._scale = h, l._datasetIndex = o.index, l._children = u, l._model = { spanGaps: f.spanGaps ? f.spanGaps : d.spanGaps, tension: a.tension ? a.tension : r.valueOrDefault(f.lineTension, c.tension), backgroundColor: a.backgroundColor ? a.backgroundColor : f.backgroundColor || c.backgroundColor, borderWidth: a.borderWidth ? a.borderWidth : f.borderWidth || c.borderWidth, borderColor: a.borderColor ? a.borderColor : f.borderColor || c.borderColor, borderCapStyle: a.borderCapStyle ? a.borderCapStyle : f.borderCapStyle || c.borderCapStyle, borderDash: a.borderDash ? a.borderDash : f.borderDash || c.borderDash, borderDashOffset: a.borderDashOffset ? a.borderDashOffset : f.borderDashOffset || c.borderDashOffset, borderJoinStyle: a.borderJoinStyle ? a.borderJoinStyle : f.borderJoinStyle || c.borderJoinStyle, fill: a.fill ? a.fill : void 0 !== f.fill ? f.fill : c.fill, steppedLine: a.steppedLine ? a.steppedLine : r.valueOrDefault(f.steppedLine, c.stepped), cubicInterpolationMode: a.cubicInterpolationMode ? a.cubicInterpolationMode : r.valueOrDefault(f.cubicInterpolationMode, c.cubicInterpolationMode) }, l.pivot()), i = 0, n = u.length; i < n; ++i) {
      ...
      var n = t(25),
        ...
        t.controllers.polarArea = t.DatasetController.extend({ dataElementType: a.Arc, linkScales: r.noop, update: function update(t) {
            ...
            for (var n = this, a = n.chart, o = n.getDataset(), s = a.options, l = s.animation, u = a.scale, d = a.data.labels, c = n.calculateCircumference(o.data[e]), h = u.xCenter, f = u.yCenter, p = 0, g = n.getMeta(), v = 0; v < e; ++v) {
              isNaN(o.data[v]) || g.data[v].hidden || ++p;
            }var m = s.startAngle,
                b = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[e]),
                y = m + c * p,
                x = y + (t.hidden ? 0 : c),
                w = l.animateScale ? 0 : u.getDistanceFromCenterForValue(o.data[e]);r.extend(t, { _datasetIndex: n.index, _index: e, _scale: u, _model: { x: h, y: f, innerRadius: 0, outerRadius: i ? w : b, startAngle: i && l.animateRotate ? m : y, endAngle: i && l.animateRotate ? m : x, label: r.valueAtIndexOrDefault(d, e, d[e]) } }), n.removeHoverStyle(t), t.pivot();
          }, removeHoverStyle: function removeHoverStyle(e) {
            t.DatasetController.prototype.removeHoverStyle.call(this, e, this.chart.options.elements.arc);
        ...
        function e(t) {
          return "top" === t || "bottom" === t;
            ...
            var r = this;i = function (t) {
              var e = (t = t || {}).data = t.data || {};return e.datasets = e.datasets || [], e.labels = e.labels || [], t.options = a.configMerge(n.global, n[t.type], t.options || {}), t;
            }(i);var o = s.acquireContext(e, i),
                l = o && o.canvas,
                u = l && l.height,
                d = l && l.width;r.id = a.uid(), r.ctx = o, r.canvas = l, r.config = i, r.width = d, r.height = u, r.aspectRatio = u ? d / u : null, r.options = i.options, r._bufferedRender = !1, r.chart = r, r.controller = r, t.instances[r.id] = r, Object.defineProperty(r, "data", { get: function get() {
            ...
            var i = this,
              ...
              var o = n.options,
                ...
                var c = t.scaleService.getScaleConstructor(u);if (!c) return;d = new c({ id: l, type: u, options: o, ctx: i.ctx, chart: i }), r[d.id] = d;
        ...
        a.extend(this, t), this.initialize.apply(this, arguments);
          ...
          var e = this,
            ...
            var r,
                ...
                h,
                f,
                p = Object.keys(i);for (r = 0, o = p.length; r < o; ++r) {
      ...
      var n = t(3),
        ...
        function e(t, e, i) {
          ...
          var i,
              ...
              p = s.bottom - s.top - d - h;return { x: i = Math.round((i - s.left - u) / f * o.width / e.currentDevicePixelRatio), y: n = Math.round((n - s.top - d) / p * o.height / e.currentDevicePixelRatio) };
        ...
        t.forEach(function (t, e) {
          ...
          if (t) {
            var o = t.options.layout || {},
                ...
                p = a(t.boxes, "top"),
                g = a(t.boxes, "bottom"),
                v = a(t.boxes, "chartArea");r(h, !0), r(f, !1), r(p, !0), r(g, !1);var m = e - l - u,
                b = i - d - c,
                y = b / 2,
                ...
                k = m,
                S = b,
                C = [];n.each(h.concat(f, p, g), function (t) {
              var e,
                  i = t.isHorizontal();i ? (e = t.update(t.fullWidth ? m : k, w), S -= e.height) : (e = t.update(x, S), k -= e.width), C.push({ horizontal: i, minSize: e, box: t });
            });var M = 0,
                P = 0,
                A = 0,
                T = 0;n.each(p.concat(g), function (t) {
              if (t.getPadding) {
                var e = t.getPadding();M = Math.max(M, e.left), P = Math.max(P, e.right);
              }
            }), n.each(h.concat(f), function (t) {
              if (t.getPadding) {
                var e = t.getPadding();A = Math.max(A, e.top), T = Math.max(T, e.bottom);
              }
            });var I = l,
                _ = u,
                D = d,
                F = c;n.each(h.concat(f), B), n.each(h, function (t) {
              I += t.width;
            }), n.each(f, function (t) {
              _ += t.width;
              ...
              var e = n.findNextWhere(C, function (e) {
                return e.box === t;
                  ...
                  i = { left: 0, right: 0, top: D, bottom: F };e && t.update(e.minSize.width, S, i);
              ...
              F += t.height;
            });var O = Math.max(M - I, 0);I += O, _ += Math.max(P - _, 0);var L = Math.max(A - D, 0);D += L, F += Math.max(T - F, 0);var R = i - D - F,
                V = e - I - _;V === k && R === S || (n.each(h, function (t) {
              t.height = R;
            }), n.each(f, function (t) {
              t.height = R;
            }), n.each(p, function (t) {
              ...
              t.fullWidth || (t.width = V);
                ...
                N = d + L;n.each(h.concat(p), E), z += k, N += S, n.each(f, E), n.each(g, E), t.chartArea = { left: I, top: D, right: I + k, bottom: D + S }, n.each(v, function (e) {
            ...
            var e = n.findNextWhere(C, function (e) {
              ...
              var i = { left: Math.max(I, M), right: Math.max(_, P), top: 0, bottom: 0 };t.update(t.fullWidth ? m : k, b / 2, i);
        ...
        function e(t, e, i) {
          ...
          return r.options.toLineHeight(r.valueOrDefault(t.lineHeight, 1.2), r.valueOrDefault(t.fontSize, n.global.defaultFontSize));
            ...
            var t = this,
                ...
                n = t.options.ticks,
                a = s(t._ticks),
                o = i(n);e.font = o.font;var l = n.minRotation || 0;if (a.length && t.options.display && t.isHorizontal()) for (var u, d = r.longestText(e, o.font, a, t.longestTextCache), c = d, h = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; c > h && l < n.maxRotation;) {
            ...
            var t = this,
                ...
                f = t.isHorizontal(),
                p = i(u),
                g = l.gridLines.tickMarkLength;if (n.width = f ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : h && c.drawTicks ? g : 0, n.height = f ? h && c.drawTicks ? g : 0 : t.maxHeight, d.display && h) {
              var v = o(d) + r.options.toPadding(d.padding).height;f ? n.height += v : n.width += v;
            }if (u.display && h) {
              var m = r.longestText(t.ctx, p.font, a, t.longestTextCache),
                  b = r.numberOfLabelLines(a),
                  y = .5 * p.size,
                  x = t.options.ticks.padding;if (f) {
                t.longestLabelWidth = m;var w = r.toRadians(t.labelRotation),
                    k = Math.cos(w),
                    S = Math.sin(w) * m + p.size * b + y * (b - 1) + y;n.height = Math.min(t.maxHeight, n.height + S + x), t.ctx.font = p.font;var C = e(t.ctx, a[0], p.font),
                    M = e(t.ctx, a[a.length - 1], p.font);0 !== t.labelRotation ? (t.paddingLeft = "bottom" === l.position ? k * C + 3 : k * y + 3, t.paddingRight = "bottom" === l.position ? k * y + 3 : k * M + 3) : (t.paddingLeft = C / 2 + 3, t.paddingRight = M / 2 + 3);
            ...
            var e,
                ...
                f = [];for (l.maxTicksLimit && (a = l.maxTicksLimit), s && (e = !1, (h + l.autoSkipPadding) * u > o.width - (o.paddingLeft + o.paddingRight) && (e = 1 + Math.floor((h + l.autoSkipPadding) * u / (o.width - (o.paddingLeft + o.paddingRight)))), a && u > a && (e = Math.max(e, Math.floor(u / a)))), i = 0; i < u; i++) {
            ...
            var e = this,
              ...
              var s = e.ctx,
                  ...
                  D = "bottom" === a.position ? e.top + A + w : e.bottom + A;if (r.each(v, function (i, n) {
                if (!r.isNullOrUndef(i.label)) {
                  var o,
                      ...
                      O,
                      L,
                      R = i.label;n === e.zeroLineIndex && a.offset === h.offsetGridLines ? (o = h.zeroLineWidth, s = h.zeroLineColor, c = h.zeroLineBorderDash, f = h.zeroLineBorderDashOffset) : (o = r.valueAtIndexOrDefault(h.lineWidth, n), s = r.valueAtIndexOrDefault(h.color, n), c = r.valueOrDefault(h.borderDash, u.borderDash), f = r.valueOrDefault(h.borderDashOffset, u.borderDashOffset));var V = "middle",
                      z = "middle",
                      N = d.padding;if (g) {
                    var B = w + N;"bottom" === a.position ? (z = p ? "middle" : "top", V = p ? "right" : "center", L = e.top + B) : (z = p ? "middle" : "bottom", V = p ? "left" : "center", L = e.bottom - B);var E = l(e, n, h.offsetGridLines && v.length > 1);E < e.left && (s = "rgba(0,0,0,0)"), E += r.aliasPixel(o), O = e.getPixelForTick(n) + d.labelOffset, m = y = k = C = E, b = _, x = D, S = t.top, F = t.bottom + A;
                  } else {
                    var W,
                        H = "left" === a.position;d.mirror ? (V = H ? "left" : "right", W = N) : (V = H ? "right" : "left", W = w + N), O = H ? e.right - W : e.left + W;var j = l(e, n, h.offsetGridLines && v.length > 1);j < e.top && (s = "rgba(0,0,0,0)"), j += r.aliasPixel(o), L = e.getPixelForTick(n) + d.labelOffset, m = T, y = I, k = t.left, C = t.right + A, b = x = S = F = j;
                  }P.push({ tx1: m, ty1: b, tx2: y, ty2: x, x1: k, y1: S, x2: C, y2: F, labelX: O, labelY: L, glWidth: o, glColor: s, glBorderDash: c, glBorderDashOffset: f, rotation: -1 * M, label: R, major: i.major, textBaseline: z, textAlign: V });
                }
              }), r.each(P, function (t) {
                if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), d.display) {
                  s.save(), s.translate(t.labelX, t.labelY), s.rotate(t.rotation), s.font = t.major ? x.font : b.font, s.fillStyle = t.major ? y : m, s.textBaseline = t.textBaseline, s.textAlign = t.textAlign;var i = t.label;if (r.isArray(i)) for (var n = i.length, a = 1.5 * b.size, o = e.isHorizontal() ? 0 : -a * (n - 1) / 2, l = 0; l < n; ++l) {
                ...
                var F,
                    O,
                    L = 0,
                    R = o(f) / 2;if (g) F = e.left + (e.right - e.left) / 2, O = "bottom" === a.position ? e.bottom - R - C.bottom : e.top + R + C.top;else {
                  var V = "left" === a.position;F = V ? e.left + R + C.top : e.right - R - C.top, O = e.top + (e.bottom - e.top) / 2, L = V ? -.5 * Math.PI : .5 * Math.PI;
                ...
                s.lineWidth = r.valueAtIndexOrDefault(h.lineWidth, 0), s.strokeStyle = r.valueAtIndexOrDefault(h.color, 0);var z = e.left,
                    N = e.right + A,
                    B = e.top,
                    E = e.bottom + A,
                    W = r.aliasPixel(s.lineWidth);g ? (B = E = "top" === a.position ? e.bottom : e.top, B += W, E += W) : (z = N = "left" === a.position ? e.right : e.left, z += W, N += W), s.beginPath(), s.moveTo(z, B), s.lineTo(N, E), s.stroke();
              }
            }
          } });
      };
        ...
        function e(t, e) {
          ...
          var e = n.global,
            ...
            var i,
              ...
              p.opacity = 1;var w = [],
                  k = [];x = t.Tooltip.positioners[h.position].call(c, g, c._eventPosition);var S = [];for (i = 0, n = g.length; i < n; ++i) {
                S.push((a = g[i], s = void 0, l = void 0, void 0, void 0, s = a._xScale, l = a._yScale || a._scale, u = a._index, d = a._datasetIndex, { xLabel: s ? s.getLabelForIndex(u, d) : "", yLabel: l ? l.getLabelForIndex(u, d) : "", index: u, datasetIndex: d, x: a._model.x, y: a._model.y }));
              ...
              }), p.title = c.getTitle(S, v), p.beforeBody = c.getBeforeBody(S, v), p.body = c.getBody(S, v), p.afterBody = c.getAfterBody(S, v), p.footer = c.getFooter(S, v), p.x = Math.round(x.x), p.y = Math.round(x.y), p.caretPadding = h.caretPadding, p.labelColors = w, p.labelTextColors = k, p.dataPoints = S, b = function (t, e, i, n) {
                var a = t.x,
                    r = t.y,
                    o = t.caretSize,
                    s = t.caretPadding,
                    ...
                    d = i.yAlign,
                    c = o + s,
                    h = l + s;return "right" === u ? a -= e.width : "center" === u && ((a -= e.width / 2) + e.width > n.width && (a = n.width - e.width), a < 0 && (a = 0)), "top" === d ? r += c : r -= "bottom" === d ? e.height + c : e.height / 2, "center" === d ? "left" === u ? a += c : "right" === u && (a -= c) : "left" === u ? a -= h : "right" === u && (a += h), { x: a, y: r };
              }(p, y = function (t, e) {
                var i = t._chart.ctx,
                    n = 2 * e.yPadding,
                    a = 0,
                ...
                }), f = 0, i.font = r.fontString(h, e._footerFontStyle, e._footerFontFamily), r.each(e.footer, p), { width: a += 2 * e.xPadding, height: n };
                ...
                }, i(s.x) ? (d = "left", a(s.x) && (d = "center", c = o(s.y))) : n(s.x) && (d = "right", r(s.x) && (d = "center", c = o(s.y)));var p = t._options;return { xAlign: p.xAlign ? p.xAlign : d, yAlign: p.yAlign ? p.yAlign : c };
              }(this, y), c._chart);
            } else p.opacity = 0;return p.xAlign = m.xAlign, p.yAlign = m.yAlign, p.x = b.x, p.y = b.y, p.width = y.width, p.height = y.height, p.caretX = x.x, p.caretY = x.y, c._model = p, e && h.custom && h.custom.call(c, p), c;
            ...
            var n,
                ...
                p = t.y,
                g = e.width,
                v = e.height;if ("center" === h) s = p + v / 2, "left" === c ? (a = (n = f) - u, r = n, o = s + u, l = s - u) : (a = (n = f + g) + u, r = n, o = s - u, l = s + u);else if ("left" === c ? (n = (a = f + d + u) - u, r = a + u) : "right" === c ? (n = (a = f + g - d - u) - u, r = a + u) : (n = (a = i.caretX) - u, r = a + u), "top" === h) s = (o = p) - u, l = o;else {
              s = (o = p + v) + u, l = o;var m = r;r = n, n = m;
            ...
            };n.fillStyle = e(i.bodyFontColor, a), r.each(i.beforeBody, d);var c = i.displayColors;u = c ? o + 2 : 0, r.each(l, function (s, l) {
            ...
            var i,
              ...
              var u = t[i];if (u && u.hasValue()) {
                var d = u.getCenterPoint(),
                    c = r.distanceBetweenPoints(e, d);c < l && (l = c, a = u);
              }
            }if (a) {
              var h = a.tooltipPosition();o = h.x, s = h.y;
            }return { x: o, y: s };
          } };
      };
        ...
        var e,
          ...
          var t,
            ...
            var d = Math.min(Math.abs(t - e), Math.abs(i - n)),
                ...
                f = e + ("right" !== o ? -c * a : 0),
                p = i + ("top" !== o ? c * r : 0),
                g = n + ("bottom" !== o ? -c * r : 0);h !== f && (i = p, n = g), p !== g && (t = h, e = f);
          }s.beginPath(), s.fillStyle = l.backgroundColor, s.strokeStyle = l.borderColor, s.lineWidth = u;var v = [[t, n], [t, i], [e, i], [e, n]],
              m = ["bottom", "left", "top", "right"].indexOf(o, 0);function b(t) {
            return v[(m + t) % 4];
          }-1 === m && (m = 0);var y = b(0);s.moveTo(y[0], y[1]);for (var x = 1; x < 4; x++) {
            ...
            if (!(isNaN(i) || i <= 0)) {
              switch (e) {default:
                  ...
                  var c = i / Math.SQRT2,
                      h = n - c,
                      f = a - c,
                      p = Math.SQRT2 * i;t.beginPath(), this.roundedRect(t, h, f, p, p, i / 2), t.closePath(), t.fill();break;case "rectRot":
      ...
      var n = t(45),
        ...
        var u,
          ...
          if (g.resizer) {
            var e = t.parentNode;e && e !== v.parentNode && e.insertBefore(v, e.firstChild), v._reset();
          }
        });
      }function v(t) {
        var e = t[a] || {},
            i = e.resizer;delete e.resizer, function (t) {
          var e = t[a] || {},
              i = e.renderProxy;i && (n.each(l, function (e) {
            f(t, e, i);
          ...
          var r = t.canvas;if ("resize" !== e) {
            var o = i[a] || (i[a] = {});h(r, e, (o.proxies || (o.proxies = {}))[t.id + "_" + e] = function (e) {
              i(function (t, e) {
                var i = u[t.type] || t.type,
                    a = n.getRelativePosition(t, e);return p(i, e, a.x, a.y, t);
              }(e, t));
            });
          } else g(r, i, t);
      ...
      var n = t(25),
        ...
        var e,
            ...
            n = t.el._scale || {},
            a = t.fill,
            r = null;if (isFinite(a)) return null;if ("start" === a ? r = void 0 === i.scaleBottom ? n.bottom : i.scaleBottom : "end" === a ? r = void 0 === i.scaleTop ? n.top : i.scaleTop : void 0 !== i.scaleZero ? r = i.scaleZero : n.getBasePosition ? r = n.getBasePosition() : n.getBasePixel && (r = n.getBasePixel()), void 0 !== r && null !== r) {
        ...
        var e = t.fill,
            i = "dataset";return !1 === e ? null : (isFinite(e) || (i = "boundary"), o[i](t));
      }function c(t) {
        return t && !t.skip;
        ...
        var o;if (n && a) {
          ...
          var i,
              ...
              h = e.propagate,
              f = [];for (n = 0; n < c; ++n) {
            o = null, (r = (i = t.getDatasetMeta(n)).dataset) && r._model && r instanceof a.Line && (o = { visible: t.isDatasetVisible(n), fill: s(r, n, c), chart: t, el: r }), i.$filler = o, f.push(o);
          }for (n = 0; n < c; ++n) {
          ...
          var i = e.meta.$filler;if (i) {
            var a = t.ctx,
                ...
                l = o._children || [],
                u = i.mapper,
                d = s.backgroundColor || n.global.defaultColor;u && d && l.length && (r.canvas.clipArea(a, t.chartArea), function (t, e, i, n, a, r) {
              var o,
                  s,
                  l,
                  u,
                  ...
                  b = [],
                  y = 0,
                  x = 0;for (t.beginPath(), o = 0, s = g + !!r; o < s; ++o) {
                d = i(u = e[l = o % g]._view, l, n), f = c(u), p = c(d), f && p ? (y = m.push(u), x = b.push(d)) : y && x && (v ? (f && m.push(u), p && b.push(d)) : (h(t, m, b, y, x), y = x = 0, m = [], b = []));
              }h(t, m, b, y, x), t.closePath(), t.fillStyle = a, t.fill();
      ...
      var n = t(25),
        ...
        return t.usePointStyle ? e * Math.SQRT2 : t.boxWidth;
          ...
          var t = this,
              ...
              p = t.legendHitBoxes = [],
              g = t.minSize,
              v = t.isHorizontal();if (v ? (g.width = t.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = t.maxHeight), a) if (o.font = f, v) {
            var m = t.lineWidths = [0],
                b = t.legendItems.length ? d + i.padding : 0;o.textAlign = "left", o.textBaseline = "top", r.each(t.legendItems, function (e, n) {
              var a = l(i, d) + d / 2 + o.measureText(e.text).width;m[m.length - 1] + a + i.padding >= t.width && (b += d + i.padding, m[m.length] = t.left), p[n] = { left: 0, top: 0, width: a, height: d }, m[m.length - 1] += a + i.padding;
            }), g.height += b;
          } else {
            var y = i.padding,
                x = t.columnWidths = [],
                ...
                k = 0,
                S = 0,
                C = d + y;r.each(t.legendItems, function (t, e) {
              var n = l(i, d) + d / 2 + o.measureText(t.text).width;S + C > g.height && (w += k + i.padding, x.push(k), k = 0, S = 0), k = Math.max(k, n), S += C, p[e] = { left: 0, top: 0, width: n, height: d };
          ...
          var t = this,
            ...
            var d,
                ...
                m = r.fontString(p, g, v);c.textAlign = "left", c.textBaseline = "middle", c.lineWidth = .5, c.strokeStyle = f, c.fillStyle = f, c.font = m;var b = l(i, p),
                y = t.legendHitBoxes,
                x = t.isHorizontal();d = x ? { x: t.left + (s - u[0]) / 2, y: t.top + i.padding, line: 0 } : { x: t.left + i.padding, y: t.top + i.padding, line: 0 };var w = p + i.padding;r.each(t.legendItems, function (n, l) {
              var f = c.measureText(n.text).width,
                  g = b + p / 2 + f,
                  v = d.x,
                  m = d.y;x ? v + g >= s && (m = d.y += w, d.line++, v = d.x = t.left + (s - u[d.line]) / 2) : m + w > t.bottom && (v = d.x = v + t.columnWidths[d.line] + i.padding, m = d.y = t.top + i.padding, d.line++), function (t, i, n) {
                if (!(isNaN(b) || b <= 0)) {
                  c.save(), c.fillStyle = h(n.fillStyle, a.defaultColor), c.lineCap = h(n.lineCap, o.borderCapStyle), c.lineDashOffset = h(n.lineDashOffset, o.borderDashOffset), c.lineJoin = h(n.lineJoin, o.borderJoinStyle), c.lineWidth = h(n.lineWidth, o.borderWidth), c.strokeStyle = h(n.strokeStyle, a.defaultColor);var s = 0 === h(n.lineWidth, o.borderWidth);if (c.setLineDash && c.setLineDash(h(n.lineDash, o.borderDash)), e.labels && e.labels.usePointStyle) {
                    var l = p * Math.SQRT2 / 2,
                        u = l / Math.SQRT2,
                        d = t + u,
                        f = i + u;r.canvas.drawPoint(c, n.pointStyle, l, d, f);
                  } else s || c.strokeRect(t, i, b, p), c.fillRect(t, i, b, p);c.restore();
                }
              }(v, m, n), y[l].left = v, y[l].top = m, function (t, e, i, n) {
                var a = p / 2,
                    r = b + a + t,
                    o = e + a;c.fillText(i.text, r, o), i.hidden && (c.beginPath(), c.lineWidth = 2, c.moveTo(r, o), c.lineTo(r + n, o), c.stroke());
      ...
      var n = t(25),
          ...
          var t = this,
            ...
            var s,
                ...
                b = t.left,
                y = t.bottom,
                x = t.right;e.fillStyle = i(a.fontColor, o.defaultFontColor), e.font = f, t.isHorizontal() ? (l = b + (x - b) / 2, u = m + g, s = x - b) : (l = "left" === a.position ? b + g : x - g, u = m + (y - m) / 2, s = y - m, v = Math.PI * ("left" === a.position ? -.5 : .5)), e.save(), e.translate(l, u), e.rotate(v), e.textAlign = "center", e.textBaseline = "middle";var w = a.text;if (r.isArray(w)) for (var k = 0, S = 0; S < w.length; ++S) {
              e.fillText(w[S], 0, k, s), k += p;
            } else e.fillText(w, 0, 0, s);e.restore();
          }
        } });function u(t, e) {
      ...
      e.exports = function (t) {
        var e = t.Scale.extend({ getLabels: function getLabels() {
            ...
            var i,
                n = this,
                a = n.options.offset,
                r = Math.max(n.maxIndex + 1 - n.minIndex - (a ? 0 : 1), 1);if (void 0 !== t && null !== t && (i = n.isHorizontal() ? t.x : t.y), void 0 !== i || void 0 !== t && isNaN(e)) {
              var o = n.getLabels();t = i || t;var s = o.indexOf(t);e = -1 !== s ? s : e;
            }if (n.isHorizontal()) {
              var l = n.width / r,
                  u = l * (e - n.minIndex);return a && (u += l / 2), n.left + Math.round(u);
            }var d = n.height / r,
                c = d * (e - n.minIndex);return a && (c += d / 2), n.top + Math.round(c);
            ...
            var e = this,
                ...
                a = e.isHorizontal(),
                r = (a ? e.width : e.height) / n;return t -= a ? e.left : e.top, i && (t -= r / 2), (t <= 0 ? 0 : Math.round(t / r)) + e.minIndex;
          }, getBasePixel: function getBasePixel() {
            return this.bottom;
            ...
            var t = this,
              ...
              var l = {};a.each(n, function (n, r) {
                var s = i.getDatasetMeta(r),
                    ...
                    c = l[u].negativeValues;i.isDatasetVisible(r) && o(s) && a.each(n.data, function (i, n) {
        ...
        var e = { position: "left", ticks: { callback: a.formatters.logarithmic } },
            ...
            var t = this,
              ...
              var i,
                  ...
                  u = Math.ceil(e.max / Math.pow(10, l));0 === s ? (i = Math.floor(n.log10(e.minNotZero)), a = Math.floor(e.minNotZero / Math.pow(10, i)), r.push(s), s = a * Math.pow(10, i)) : (i = Math.floor(n.log10(s)), a = Math.floor(s / Math.pow(10, i)));var d = i < 0 ? Math.pow(10, Math.abs(i)) : 1;do {
                r.push(s), 10 == ++a && (a = 1, d = ++i >= 0 ? 1 : d), s = Math.round(a * Math.pow(10, i) * d) / d;
              } while (i < l || i === l && a < u);var c = o(t.max, s);return r.push(c), r;
            ...
            var i,
                ...
                h = 0;return e = +l.getRightValue(e), u ? (r = l.end, o = l.start, s = -1) : (r = l.start, o = l.end, s = 1), l.isHorizontal() ? (i = l.width, a = u ? l.right : l.left) : (i = l.height, s *= -1, a = u ? l.top : l.bottom), e !== r && (0 === r && (i -= h = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize), r = c), 0 !== e && (h += i / (d(o) - d(r)) * (d(e) - d(r))), a += s * h), a;
            ...
            var i,
              ...
              if (0 === a) {
                var c = n.getValueOrDefault(s.options.ticks.fontSize, t.defaults.global.defaultFontSize);o -= c, i -= c, a = d;
      ...
      var n = t(25),
          ...
          return a.isNumber(t) ? t : 0;
        }var f = t.LinearScaleBase.extend({ setDimensions: function setDimensions() {
            var t = this,
                i = t.options,
            ...
            var t, e;this.options.pointLabels.display ? function (t) {
              var e,
                  ...
                  c = {};t.ctx.font = r.font, t._pointLabelSizes = [];var h,
                  f,
                  p,
                  g = o(t);for (e = 0; e < g; e++) {
                n = t.getPointPosition(e, u), h = t.ctx, f = r.size, p = t.pointLabels[e] || "", i = a.isArray(p) ? { w: a.longestText(h, h.font, p), h: p.length * f + 1.5 * (p.length - 1) * f } : { w: h.measureText(p).width, h: f }, t._pointLabelSizes[e] = i;var v = t.getIndexAngle(e),
                    m = a.toDegrees(v) % 360,
                    b = l(m, n.x, i.w, 0, 180),
                    y = l(m, n.y, i.h, 90, 270);b.start < d.l && (d.l = b.start, c.l = v), b.end > d.r && (d.r = b.end, c.r = v), y.start < d.t && (d.t = y.start, c.t = v), y.end > d.b && (d.b = y.end, c.b = v);
            ...
            var n = e.l / Math.sin(i.l),
                ...
                r = -e.t / Math.cos(i.t),
                o = -Math.max(e.b - this.height, 0) / Math.cos(i.b);n = h(n), a = h(a), r = h(r), o = h(o), this.drawingArea = Math.min(Math.round(t - (n + a) / 2), Math.round(t - (r + o) / 2)), this.setCenterPoint(n, a, r, o);
            ...
            var t = this,
              ...
              var h = t.ctx,
                  ...
                  m = a.fontString(p, g, v);a.each(t.ticks, function (i, s) {
                if (s > 0 || r.reverse) {
                  var u = t.getDistanceFromCenterForValue(t.ticksAsNumbers[s]);if (n.display && 0 !== s && function (t, e, i, n) {
                    ...
                    var d = l(r.fontColor, e.defaultFontColor);if (h.font = m, h.save(), h.translate(t.xCenter, t.yCenter), h.rotate(f), r.showLabelBackdrop) {
                      var c = h.measureText(i).width;h.fillStyle = r.backdropColor, h.fillRect(-c / 2 - r.backdropPaddingX, -u - p / 2 - r.backdropPaddingY, c + 2 * r.backdropPaddingX, p + 2 * r.backdropPaddingY);
                ...
                var i = t.ctx,
                    n = t.options,
                    r = n.angleLines,
                    l = n.pointLabels;i.lineWidth = r.lineWidth, i.strokeStyle = r.color;var h = t.getDistanceFromCenterForValue(n.ticks.reverse ? t.min : t.max),
                    f = s(t);i.textBaseline = "top";for (var p = o(t) - 1; p >= 0; p--) {
                  if (r.display) {
                    var g = t.getPointPosition(p, h);i.beginPath(), i.moveTo(t.xCenter, t.yCenter), i.lineTo(g.x, g.y), i.stroke(), i.closePath();
                  }if (l.display) {
                    var v = t.getPointPosition(p, h + 5),
                        m = a.valueAtIndexOrDefault(l.fontColor, p, e.defaultFontColor);i.font = f.font, i.fillStyle = m;var b = t.getIndexAngle(p),
                        y = a.toDegrees(b);i.textAlign = u(y), c(y, t._pointLabelSizes[p], v), d(i, t.pointLabels[p] || "", v, f.size);
                  }
                }
              }(t);
            }
      ...
      var n = t(1);n = "function" == typeof n ? n : window.moment;var a = t(25),
        ...
        var o,
          ...
          var a,
              ...
              u = l[i],
              d = u.size,
              c = u.steps;if (!c) return Math.ceil(s / (n * d));for (a = 0, r = c.length; a < r && (o = c[a], !(Math.ceil(s / (d * o)) <= n)); ++a) {}return o;
        }(t, e, c, i)), p && (b = b.isoWeekday(p), y = y.isoWeekday(p)), b = b.startOf(p ? "day" : c), (y = y.startOf(p ? "day" : c)) < e && y.add(1, c), o = n(b), v && h && !p && !d.round && (o.startOf(h), o.add(~~((b - o) / (m.size * f)) * f, c)); o < y; o.add(f, c)) {
          x.push(+o);
        }return x.push(+o), x;
      }e.exports = function (t) {
        var e = t.Scale.extend({ initialize: function initialize() {
            ...
            var t,
                ...
                y = [],
                x = [],
                w = [];for (t = 0, i = f.data.labels.length; t < i; ++t) {
            ...
            }w.length && (w = c(w).sort(d), m = Math.min(m, w[0]), b = Math.max(b, w[w.length - 1])), y.length && (y = c(y).sort(d), m = Math.min(m, y[0]), b = Math.max(b, y[y.length - 1])), m = p(g.min, h) || m, b = p(g.max, h) || b, m = m === s ? +n().startOf(v) : m, b = b === o ? +n().endOf(v) + 1 : b, h.min = Math.min(m, b), h.max = Math.max(m + 1, b), h._horizontal = h.isHorizontal(), h._table = [], h._timestamps = { data: y, datasets: x, labels: w };
          }, buildTicks: function buildTicks() {
            var t,
                e,
                i,
                ...
                d = s.time,
                c = [],
                m = [];switch (s.ticks.source) {case "data":
                c = a._timestamps.data;break;case "labels":
                c = a._timestamps.labels;break;case "auto":default:
                c = v(r, o, a.getLabelCapacity(r), s);}for ("ticks" === s.bounds && c.length && (r = c[0], o = c[c.length - 1]), r = p(d.min, a) || r, o = p(d.max, a) || o, t = 0, e = c.length; t < e; ++t) {
            ...
            }(m, d.minUnit, a.min, a.max), a._majorUnit = g(a._unit), a._table = function (t, e, i, n) {
              ...
              var r,
                  o,
                  s = 0,
                  l = 0;return a.offset && e.length && (a.time.min || (r = e.length > 1 ? e[1] : n, o = e[0], s = (h(t, "time", r, "pos") - h(t, "time", o, "pos")) / 2), a.time.max || (r = e[e.length - 1], o = e.length > 1 ? e[e.length - 2] : i, l = (h(t, "time", r, "pos") - h(t, "time", o, "pos")) / 2)), { left: s, right: l };
            }(a._table, m, r, o, s), a._labelFormat = function (t, e) {
              var i,
                  n,
                  a,
            ...
            var a = this.options,
                ...
                p = t.format(n || (f ? d : l)),
                g = f ? h : a.ticks.minor,
                v = r.valueOrDefault(g.callback, g.userCallback);return v ? v(p, e, i) : p;
            ...
            var n = null;if (void 0 !== e && void 0 !== i && (n = this._timestamps.datasets[i][e]), null === n && (n = p(t, this)), null !== n) return this.getPixelForOffset(n);
          }, getPixelForTick: function getPixelForTick(t) {
            ...
            var e = this,
                ...
                o = h(e._table, "pos", r, "time");return n(o);
            ...
            var e = this,
                ...
                s = Math.floor(o / r);return s > 0 ? s : 1;
  ...
  WOW = function WOW() {
    return { init: function init() {
        var e = [],
          ...
          var i = window.innerHeight,
            ...
            if ("visible" != t(this).css("visibility") && (i + n - 100 > a(this) && n < a(this) || i + n - 100 > a(this) + t(this).height() && n < a(this) + t(this).height() || i + n == t(document).height() && a(this) + 100 > t(document).height())) {
              var r = t(this).index(".wow"),
                  o = t(this).attr("data-wow-delay");if (o) {
                o = t(this).attr("data-wow-delay").slice(0, -1);var s = this;parseFloat(o);t(s).addClass("animated"), t(s).css({ visibility: "visible" }), t(s).css({ "animation-delay": o }), t(s).css({ "animation-name": e[r] });var l = 1e3 * t(this).css("animation-duration").slice(0, -1);t(this).attr("data-wow-delay") && (l += 1e3 * t(this).attr("data-wow-delay").slice(0, -1));s = this;setTimeout(function () {
                  t(s).removeClass("animated");
                }, l);
              } else {
                t(this).addClass("animated"), t(this).css({ visibility: "visible" }), t(this).css({ "animation-name": e[r] });l = 1e3 * t(this).css("animation-duration").slice(0, -1), s = this;setTimeout(function () {
                  t(s).removeClass("animated");
                }, l);
              }
            }
          ...
          var e, r;i ? (e = window.innerHeight, r = window.scrollY, t(".wow.animated").each(function () {
            if (e + r - 100 > a(this) && r > a(this) + 100 || e + r - 100 < a(this) && r < a(this) + 100 || a(this) + t(this).height > t(document).height() - 100) t(this).removeClass("animated"), t(this).css({ "animation-name": "none" }), t(this).css({ visibility: "hidden" });else {
              var i = 1e3 * t(this).css("animation-duration").slice(0, -1);t(this).attr("data-wow-delay") && (i += 1e3 * t(this).attr("data-wow-delay").slice(0, -1));var n = this;setTimeout(function () {
  ...
  t(window).on("scroll", function () {
    var e = t(".navbar");e.length && (e.offset().top > 50 ? t(".scrolling-navbar").addClass("top-nav-collapse") : t(".scrolling-navbar").removeClass("top-nav-collapse"));
  });
}(jQuery), function (t, e) {
  "use strict";
  ...
  var t = t || {},
      ...
      n = "ontouchstart" in window;function a(t) {
    var e = typeof t === "undefined" ? "undefined" : _typeof(t);return "function" === e || "object" === e && !!t;
  }function r(t) {
    var n,
        r = i.call(t);return "[object String]" === r ? e(t) : a(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(r) && t.hasOwnProperty("length") ? t : a(n = t) && n.nodeType > 0 ? [t] : [];
  }function o(t) {
    var e,
        i,
        n = { top: 0, left: 0 },
        a = t && t.ownerDocument;return e = a.documentElement, void 0 !== t.getBoundingClientRect && (n = t.getBoundingClientRect()), i = function (t) {
      return null !== (e = t) && e === e.window ? t : 9 === t.nodeType && t.defaultView;var e;
    }(a), { top: n.top + i.pageYOffset - e.clientTop, left: n.left + i.pageXOffset - e.clientLeft };
  }function s(t) {
    var e = "";for (var i in t) {
      t.hasOwnProperty(i) && (e += i + ":" + t[i] + ";");
    }return e;
  }var l = { duration: 750, delay: 200, show: function show(t, e, i) {
      if (2 === t.button) return !1;e = e || this;var n = document.createElement("div");n.className = "waves-ripple waves-rippling", e.appendChild(n);var a = o(e),
          r = 0,
          u = 0;"touches" in t && t.touches.length ? (r = t.touches[0].pageY - a.top, u = t.touches[0].pageX - a.left) : (r = t.pageY - a.top, u = t.pageX - a.left), u = u >= 0 ? u : 0, r = r >= 0 ? r : 0;var d = "scale(" + e.clientWidth / 100 * 3 + ")",
          c = "translate(0,0)";i && (c = "translate(" + i.x + "px, " + i.y + "px)"), n.setAttribute("data-hold", Date.now()), n.setAttribute("data-x", u), n.setAttribute("data-y", r), n.setAttribute("data-scale", d), n.setAttribute("data-translate", c);var h = { top: r + "px", left: u + "px" };n.classList.add("waves-notransition"), n.setAttribute("style", s(h)), n.classList.remove("waves-notransition"), h["-webkit-transform"] = d + " " + c, h["-moz-transform"] = d + " " + c, h["-ms-transform"] = d + " " + c, h["-o-transform"] = d + " " + c, h.transform = d + " " + c, h.opacity = "1";var f = "mousemove" === t.type ? 2500 : l.duration;h["-webkit-transition-duration"] = f + "ms", h["-moz-transition-duration"] = f + "ms", h["-o-transition-duration"] = f + "ms", h["transition-duration"] = f + "ms", n.setAttribute("style", s(h));
      ...
      var e = t.parentNode;if ("i" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
        var i = document.createElement("i");i.className = t.className + " waves-input-wrapper", t.className = "waves-button-input", e.replaceChild(i, t), i.appendChild(t);var n = window.getComputedStyle(t, null),
            a = n.color,
            r = n.backgroundColor;i.setAttribute("style", "color:" + a + ";background:" + r), t.setAttribute("style", "background-color:rgba(0,0,0,0);");
      }
    }, img: function img(t) {
      var e = t.parentNode;if ("i" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
    ...
    if (i) {
      i.classList.remove("waves-rippling");var n = i.getAttribute("data-x"),
          ...
          u = 350 - (Date.now() - Number(i.getAttribute("data-hold")));u < 0 && (u = 0), "mousemove" === t.type && (u = 150);var d = "mousemove" === t.type ? 2500 : l.duration;setTimeout(function () {
        var t = { top: a + "px", left: n + "px", opacity: "0", "-webkit-transition-duration": d + "ms", "-moz-transition-duration": d + "ms", "-o-transition-duration": d + "ms", "transition-duration": d + "ms", "-webkit-transform": r + " " + o, "-moz-transform": r + " " + o, "-ms-transform": r + " " + o, "-o-transform": r + " " + o, transform: r + " " + o };i.setAttribute("style", s(t)), setTimeout(function () {
          try {
            e.removeChild(i);
          } catch (t) {
            return !1;
  ...
  }var c = { touches: 0, allowEvent: function allowEvent(t) {
      var e = !0;return (/^(mousedown|mousemove)$/.test(t.type) && c.touches && (e = !1), e
      );
    }, registerEvent: function registerEvent(t) {
      var e = t.type;"touchstart" === e ? c.touches += 1 : /^(touchend|touchcancel)$/.test(e) && setTimeout(function () {
        c.touches && (c.touches -= 1);
      }, 500);
    } };function h(t) {
    var e = function (t) {
      if (!1 === c.allowEvent(t)) return null;for (var e = null, i = t.target || t.srcElement; i.parentElement;) {
        if (!(i instanceof SVGElement) && i.classList.contains("waves-effect")) {
          e = i;break;
        }i = i.parentElement;
      }return e;
    }(t);if (null !== e) {
      if (e.disabled || e.getAttribute("disabled") || e.classList.contains("disabled")) return;if (c.registerEvent(t), "touchstart" === t.type && l.delay) {
        var i = !1,
        ...
        };e.addEventListener("touchmove", o, !1), e.addEventListener("touchend", r, !1), e.addEventListener("touchcancel", r, !1);var s = function s() {
    ...
    var e = document.body;"duration" in (t = t || {}) && (l.duration = t.duration), "delay" in t && (l.delay = t.delay), n && (e.addEventListener("touchstart", h, !1), e.addEventListener("touchcancel", c.registerEvent, !1), e.addEventListener("touchend", c.registerEvent, !1)), e.addEventListener("mousedown", h, !1);
  }, t.attach = function (t, e) {
    var n, a;t = r(t), "[object Array]" === i.call(e) && (e = e.join(" ")), e = e ? " " + e : "";for (var o = 0, s = t.length; o < s; o++) {
    ...
    var i = (t = r(t)).length;if ((e = e || {}).wait = e.wait || 0, e.position = e.position || null, i) for (var n, a, s, u = {}, d = 0, c = { type: "mousedown", button: 1 }, h = function h(t, e) {
      return function () {
        l.hide(t, e);
      };
    }; d < i; d++) {
      if (n = t[d], a = e.position || { x: n.clientWidth / 2, y: n.clientHeight / 2 }, s = o(n), u.x = s.left + a.x, u.y = s.top + a.y, c.pageX = u.x, c.pageY = u.y, l.show(c, n), e.wait >= 0 && null !== e.wait) {
        setTimeout(h({ type: "mouseup", button: 1 }, n), e.wait);
      }
    }
  }, t.calm = function (t) {
    for (var e = { type: "mouseup", button: 1 }, i = 0, n = (t = r(t)).length; i < n; i++) {
      l.hide(e, t[i]);
    }
  ...
  var e = ["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function (t) {
    ...
    var e = t(void 0);if (e.val().length) {
      var i = t(".hiddendiv"),
          n = e.css("font-family"),
          a = e.css("font-size");a && i.css("font-size", a), n && i.css("font-family", n), "off" === e.attr("wrap") && i.css("overflow-wrap", "normal").css("white-space", "pre"), i.text(e.val() + "\n");var r = i.html().replace(/\n/g, "<br>");i.html(r), i.css("width", e.is(":visible") ? e.width() : t(window).width() / 2), e.css("height", i.height());
    }
  };t(e).each(function (e, n) {
    var a = t(n),
        r = a.siblings("label, i");i(a), n.validity.badInput && r.addClass("active");
    ...
    var i = t(e.target),
        ...
        o = void 0 === i.attr("placeholder");a && r && o && i.siblings("label, i").removeClass("active"), n(i);
  }), t(document).on("change", e, function (e) {
    var a = t(e.target);i(a), n(a);
  }), t("input[autofocus]").siblings("label, i").addClass("active"), t(document).on("reset", function (i) {
    var n = t(i.target);n.is("form") && (n.find(e).removeClass("valid").removeClass("invalid").each(function (e, i) {
      var n = t(i),
          a = !n.val(),
    ...
    var e = t(".md-textarea-auto");if (e.length) {
      var i = void 0;i = window.attachEvent ? function (t, e, i) {
        ...
        }i(t, "change", e), i(t, "cut", n), i(t, "paste", n), i(t, "drop", n), i(t, "keydown", n), e();
      });
    }
  }();var r = t("body");if (!t(".hiddendiv").first().length) {
    var o = t('<div class="hiddendiv common"></div>');r.append(o);
  }t(".materialize-textarea").each(a), r.on("keyup keydown", ".materialize-textarea", a);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(0), __webpack_require__(20)(module), __webpack_require__(21), __webpack_require__(0)))
